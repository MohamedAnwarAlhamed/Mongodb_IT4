...
db.restaurand.find(
    {$and:[{"borough":{$ne:"Bronx"}},{"borough":{$ne:"Brooklyn"}},{"borough":{$ne:"Staten Island"}},{"borough":{$ne:"Queens"}},]},
    {"restaurant_id":1,"name":1,"borough":1,"cuisine":1,});
...
db.restaurand.find(
    {$or:[{"borough":"Bronx"},{"borough":"Brooklyn"},{"borough":"Staten Island"},{"borough":"Queens"},]},
    {"restaurant_id":1,"name":1,"borough":1,"cuisine":1,});
